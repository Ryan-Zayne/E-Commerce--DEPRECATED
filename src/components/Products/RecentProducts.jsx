...
function RecentProducts() {
	...
	return (
		<article id="Recently Viewed" className="flex flex-col gap-[2rem] px-[3rem]">
			<h2 className="text-[2rem] font-[700] max-md:text-center">Recently Viewed</h2>
			<ul className="grid grid-cols-[repeat(auto-fit,_minmax(23rem,1fr))] justify-items-center gap-[3rem_1rem]">
				{renderedProducts}
			</ul>
		</article>
	);
