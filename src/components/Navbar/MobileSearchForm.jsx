...
const MobileSearchForm = ({ searchShow }) => {
	...
	return (
		<form className={FORM_CLASSES} onSubmit={(e) => e.preventDefault()}>
			<input
				className="bg- w-[100%] rounded-[2.5rem_0_0_2.5rem] border-secondary bg-[var(--color-body,_white)] py-[0.6rem] pl-[2.3rem] transition-[box-shadow] duration-200 [border-width:2px_0_2px_2px] placeholder:font-[500] placeholder:text-placeholder focus-within:shadow-[1px_0_10px_2px_var(--color-secondary)]"
				type="text"
				name="Search"
